...
class TestOrderViewSet(APITestCase):
    ...
    def test_order(self):
        ...
        self.assertEqual(float(order_data['results'][0]['products'][0]['price']), float(self.product.price))
        self.assertEqual(order_data['results'][0]['products'][0]['active'], self.product.active)
